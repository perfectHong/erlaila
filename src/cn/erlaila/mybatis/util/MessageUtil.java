...
public class MessageUtil{
	...
	static final String accessKeyId = "LTAIMcXjmAGgCMBX";
	static final String accessKeySecret = "YNNrbyb2M59VCRsM4xOmMNW2TIxAt2";
	...
	public static SendSmsResponse sendSms(String phone, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("儿来啦");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_110470003");
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
		...
		// 必填-号码
		request.setPhoneNumber("15573313526");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		// 发短信
		String x=createCode(6);
		SendSmsResponse response = sendSms("13647096349", x);
