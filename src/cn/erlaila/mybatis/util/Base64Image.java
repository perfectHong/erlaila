...
public class Base64Image {
  ...
  public static void main(String[] args) {
    ...
    //将图片文件 转换为Base64编码
    String path="f:\\1509587730989.jpg";//图片位置
    String str=GetImageStr(path);
  ...
  public static boolean GenerateImage(String imgStr, String imgFilePath) {// 字节数组字符串进行Base64解码并生成图片
